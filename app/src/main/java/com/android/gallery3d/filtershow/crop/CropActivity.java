...
public class CropActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setCustomView(R.layout.filter_show_actionbar);
     ...
     * @see #doneLoadBitmap(Bitmap, RectF, int)
     */
    private class LoadBitmapTask extends AsyncTask<Uri, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Uri... params) {
            Uri uri = params[0];
            Bitmap bitmap = ImageLoader.loadConstrainedBitmap(uri, mContext, mBitmapSize, mOriginalBounds, false);
    ...
    protected static CropExtras getExtrasFromIntent(Intent intent) {
        ...
        if (extras != null) {
            return new CropExtras(extras.getInt(CropExtras.KEY_OUTPUT_X, 0),
                    ...
                    extras.getBoolean(CropExtras.KEY_SCALE, true) && extras.getBoolean(CropExtras.KEY_SCALE_UP_IF_NEEDED, false),
