...
public class UndoBarView extends GLView {
    ...
    public UndoBarView(Context context) {
        ...
        mUndoText = StringTexture.newInstance(context.getString(R.string.undo), GalleryUtils.dpToPixel(12), GRAY, 0, true);
        mDeletedText = StringTexture.newInstance(context.getString(R.string.deleted), GalleryUtils.dpToPixel(16), WHITE);
        mUndoIcon = new ResourceTexture(context, R.drawable.ic_menu_revert_holo_dark);
        mClickRegion = mBarMargin + mUndoTextMargin + mUndoText.getWidth() + mIconMargin + mIconSize + mSeparatorRightMargin;
    }
