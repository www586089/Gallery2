...
public class StateManager {
    ...
    public void startState(Class<? extends ActivityState> klass, Bundle data) {
        ...
        UsageStatistics.onContentViewChanged(COMPONENT_GALLERY, klass.getSimpleName());
    ...
    void finishState(ActivityState state, boolean fireOnPause) {
        ...
        if (top != null) {
            UsageStatistics.onContentViewChanged(COMPONENT_GALLERY, top.getClass().getSimpleName());
        }
    }
    ...
    public void restoreFromState(Bundle inState) {
        ...
        if (topState != null) {
            UsageStatistics.onContentViewChanged(COMPONENT_GALLERY,
